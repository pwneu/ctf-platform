      ...
      <div className="container">
        ...
        <div className="row y-gap-30 pt-60 lg:pt-50 justify-content-center">
          {developers.map((elm) => (
            <div
              ...
              onClick={() => window.open(elm.url, "_blank")}
        ...
        <div className="row y-gap-30 pt-20 lg:pt-50 justify-content-center text-white mt-8 px-4 text-center max-w-2xl">
          <p
            ...
            data-aos-duration={900}
          >
            We are developers and CTF (Capture The Flag) players, dedicated to
            providing a dynamic and engaging learning platform for students
            pursuing cybersecurity at New Era University. Our mission is to
            encourage and empower students by offering them the tools,
