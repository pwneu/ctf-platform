  ...
  return (
    ...
    >
      <div className="container">
        ...
        <div className={`row y-gap-1 justify-between sm:justify-start items-center pt-20 md:pt-50`}>
...
Organization.propTypes = {
  backgroundColorComponent: PropTypes.string,
  brandsTwo: PropTypes.bool,
};
