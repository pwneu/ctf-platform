...
export default function AchievementsOne() {
  ...
  useEffect(() => {
    if (currentCategory == "All Categories") {
      ...
      let filtered = achievements3.filter(
              ...
              <div className="col-auto">
                ...
                <div>
                  <p className="page-header__text">
                    These articles provide valuable insights and information on
                    cybersecurity topics, designed to help you build essential
                    skills and deepen <br />
