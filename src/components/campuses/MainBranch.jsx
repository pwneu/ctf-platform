        ...
        <div className="row y-gap-30 justify-between items-center">
          ...
          >
            ...
            <p className="mt-25 text-center">
              ...
              year 1978 saw the opening of NEEI&rsquo;s collegiate course
              offerings at the Evangelical College (EVCO) building along Don
              Mariano Marcos (now Commonwealth) Avenue, Diliman, Quezon City.
              Upon the conferment of degrees to 12 collegiate graduates in 1981,
              the school became known as the New Era College (NEC). On May 10,
              1986, the permanent building for NEC was inaugurated, situated in
              a wide expanse of land along St. Joseph Street, Milton Hills
              Subdivision, Diliman, (now known as #9 Central Avenue, New Era)
              Quezon City. NEC was granted &#39;University&#39; status by the
              Commission on Higher Education (CHEd) on June 30, 1995, thus
              adopting its present name, New Era University.
            </p>
          </div>
        </div>
      </div>
