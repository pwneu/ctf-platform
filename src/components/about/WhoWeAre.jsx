        ...
        <div className="container">
          <div className="row y-gap-30 justify-between items-center">
            <div className="col-xl-5 col-lg-6 col-md-9 lg:order-2">
              <h3 className="text-40 lh-1 text-center">Who We Are</h3>
              <p className="mt-25 text-center">
                We are the CTF (Capture The Flag) Player, dedicated to providing
                a dynamic and engaging learning platform for students pursuing
                cybersecurity at New Era University. Our mission is to encourage
            ...
            <div className="col-lg-6 lg:order-1">
              <img
                className="w-1/1"
                src="/assets/img/about/whoweare/whoweare_Card.svg"
                alt="image"
              />
            </div>
          </div>
